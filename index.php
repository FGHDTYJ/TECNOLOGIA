   ...
   <nav class="navbar fixed-top navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <h3 class="my-heading ">NEXT LEVEL<span class="bg-main">TECHNOLOGY</span></h3>
            </a>
              <div class="collapse navbar-collapse" id="navbarResponsive">
                              <ul class="navbar-nav ml-auto">
                    <li class="nav-link">
                        <a class="btn btn-primary btn-block btn-login" href="PRODUCTOS.php">PRODUCTOS</a>
                    </li>
                 </ul>
            </div>
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">NEXT LEVEL<span class="bg-main">TECHNOLOGY</span></h3>
                    <p class="myp-slider text-center">"NEXT LEVEL: TU PUERTA ALMUNDO TECNOLOGICO."</p>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="inner-section wow fadeInUp">
                        <h3>NEXT LEVEL<span class="bg-main">TECHNOLOGY</span></h3>
                        <br>
                        <p class="text-justify">En FashionHub, la calidad no es solo una promesa, es un estándar. Nuestros productos no solo siguen las últimas tendencias, sino que están confeccionados con atención a los detalles y con materiales que cumplen con los más altos estándares. Creemos que la moda de alta calidad no debería ser un lujo inalcanzable, por lo que nos esforzamos por hacerla accesible para todos.
                         
                            Nuestra dedicación no se detiene en la calidad de los productos; también nos comprometemos a brindarte una experiencia de compra sin contratiempos. Desde el momento en que realizas tu pedido hasta que lo recibes en tu puerta, nos aseguramos de que el proceso sea eficiente y transparente. En FashionHub, no solo vendemos ropa, proporcionamos una conexión entre tu estilo personal y la calidad que mereces.</p>

                        <div class="linear-grid">
                            <div class="row">
                                <div class="col-sm-6 col-md-3 mb-2 wow bounceInUp" data-wow-duration="1.4s" >
                                    <img src="IMG/FONDO.JPG" class="img-thumbnail">
                                </div>
                                <div class=" col-sm-6 col-md-3 mb-2 wow bounceInUp" data-wow-duration="1.4s">
                                    <img src="IMG/LOGO2.JPG" class="img-thumbnail">
                                </div>
                                <div class="col-sm-6 col-md-3 mb-2 wow bounceInUp" data-wow-duration="1.4s">
                                    <img src="IMG/FONDO.JPG" class="img-thumbnail">
                                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 wow fadeInUp">
                    <h3 class="title-heading text-center">RIFA DE PRODUCTOS</h3>
